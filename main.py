...
janela = tk.Tk()
janela.title("Cálculo Numérico - Métodos Computacionais")
...
#     with open("src/arquivos/arq_escrita.txt", "w", encoding="utf-8") as arquivo:
#         arquivo.write(f"{'Método':<15}{'Raiz Aproximada':<20}{'Iterações':<15}\n")

#     secante(prmt[0], prmt[1], prmt[2], prmt[3])
#     newton(prmt[0], prmt[1], prmt[2], prmt[3])
